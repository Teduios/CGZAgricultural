...
- (void)setImageView {
    [UIImageView setRoundImage:self.headImageView Radius:30];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 1 && indexPath.row == 0) {
        ...
        CGZBaseNaviController *navController = [[CGZBaseNaviController alloc]initWithRootViewController:collectionViewController];
